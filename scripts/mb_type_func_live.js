...
export function mb_type_func(args) {
  for (let y = 0; y < args.mb_types.length; y++) {
    for (let x = 0; x < args.mb_types[y].length; x++) {
      // Just mark macroblocks for inter prediction
      args.mb_types[y][x] = 1; // 1 = INTER macroblock
    }
  }
}
