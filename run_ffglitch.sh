...
./bin/ffgac -i "$FILE" -vcodec mpeg4 -mpv_flags +nopimb+forcemv   -qscale:v 1 -fcode 5 -g max -sc_threshold max   -mb_type_script ./scripts/mb_type_func_live_simple.js   -f m4v pipe: | ./bin/fflive -i -f m4v pipe: -s ./scripts/live_from_gpio.js
